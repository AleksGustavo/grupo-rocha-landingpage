...
{/* ==========================================
    TERCEIRA DOBRA: SERVIÇOS (SLIDER DINÂMICO) - TAMANHO REDUZIDO & MOBILE 2x2
    ========================================== */}
    
<section id="servicos" className="relative w-full bg-[#121417] py-16 md:py-20 px-4 sm:px-6 border-t border-white/5 z-10 overflow-hidden">
  <div className="max-w-7xl mx-auto flex flex-col gap-10">
    ...
    <div className="relative flex items-center justify-between gap-2 sm:gap-4 w-full max-w-5xl mx-auto">
      ...
      {/* Removemos a altura fixa excessiva para evitar quebras de layout */}
      <div className="relative flex-grow min-h-[380px] sm:min-h-[400px] md:min-h-[360px]">
        
        {/* GRUPO 1: CARDS 1, 2 e 3 */}
        {/* Alterado para grid-cols-2 no mobile e md:grid-cols-3 no desktop */}
        <div className={`grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 items-stretch absolute inset-0 w-full transition-all duration-700 ease-in-out ${
          ...
          {/* CARD 1: ARQUITETURA */}
          <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-4 sm:p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 hover:-translate-y-1 group cursor-pointer">
            <div className="text-[#c5a880] group-hover:text-white transition-colors duration-300 mt-2 transform group-hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 sm:w-11 sm:h-11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="m15 5-3-3-3 3"/><path d="M12 2v20"/><path d="m5 16 7-9 7 9"/><path d="M19 19H5"/></svg>
            </div>
            <div className="flex flex-col items-center flex-grow justify-center mt-4">
              <h3 className="font-serif text-base sm:text-xl md:text-2xl tracking-wide font-light text-white mb-2">Arquitetura</h3>
              <p className="text-[11px] sm:text-sm md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-4 md:line-clamp-none">Projetos conceituais que equilibram perfeitamente criatividade, estética e funcionalidade residencial.</p>
            </div>
          </div>
          ...
          <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-4 sm:p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 hover:-translate-y-1 group cursor-pointer">
            <div className="text-[#c5a880] group-hover:text-white transition-colors duration-300 mt-2 transform group-hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 sm:w-11 sm:h-11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
            </div>
            <div className="flex flex-col items-center flex-grow justify-center mt-4">
              <h3 className="font-serif text-base sm:text-xl md:text-2xl tracking-wide font-light text-white mb-2">Residencial</h3>
              <p className="text-[11px] sm:text-sm md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-4 md:line-clamp-none">Casas exclusivas de alto padrão construídas do zero com precisão, engenharia fina e cuidado absoluto.</p>
            </div>
          </div>

          {/* CARD 3: EDIFICAÇÕES COMERCIAIS */}
          {/* Adicionado 'hidden md:flex' para que no mobile (grid-cols-2) este 3º card não quebre o layout empilhando para baixo */}
        ...
        <div className={`grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 items-stretch absolute inset-0 w-full transition-all duration-700 ease-in-out ${
          ...
          <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-4 sm:p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 hover:-translate-y-1 group cursor-pointer">
            <div className="text-[#c5a880] group-hover:text-white transition-colors duration-300 mt-2 transform group-hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 sm:w-11 sm:h-11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11h18"/><path d="M5 11V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v4"/><path d="M12 2v3"/><path d="M6 11v7c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2v-7"/><path d="M9 20v2"/><path d="M15 20v2"/></svg>
            </div>
            <div className="flex flex-col items-center flex-grow justify-center mt-4">
              <h3 className="font-serif text-base sm:text-xl md:text-2xl tracking-wide font-light text-white mb-2">Interiores</h3>
              <p className="text-[11px] sm:text-sm md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-4 md:line-clamp-none">Interiores sofisticados, marcenaria planejada e detalhamento estético totalmente adaptados ao seu bem-estar.</p>
            </div>
          </div>
          ...
          <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-4 sm:p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 hover:-translate-y-1 group cursor-pointer">
            ...
            <div className="flex flex-col items-center flex-grow justify-center mt-4">
              <h3 className="font-serif text-base sm:text-xl md:text-2xl tracking-wide font-light text-white mb-2">Gestão de Obras</h3>
              <p className="text-[11px] sm:text-sm md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-4 md:line-clamp-none">Execução contínua e transparente, cuidando do gerenciamento de custos à entrega final das chaves.</p>
            </div>
          </div>

          {/* CARD 6: CONSULTORIA TÉCNICA */}
          {/* Oculto no mobile para manter simetria 2x2 do slider */}
          <div className="hidden md:flex bg-[#1a1d24]/40 border border-white/20 rounded-xl p-8 flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 hover:-translate-y-1 group cursor-pointer">
            <div className="text-[#c5a880] group-hover:text-white transition-colors duration-300 mt-4 transform group-hover:scale-110 transition-transform">

          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col justify-center items-start bg-[#121417]/60 md:bg-transparent p-6 md:p-0 rounded-md md:rounded-none backdrop-blur-sm md:backdrop-blur-none transform -translate-y-4">
              ...
              <p className="mt-4 text-gray-400 max-w-md text-xs sm:text-sm tracking-wide leading-relaxed">
                Há mais de 20 anos no mercado da construção civil, transformamos visões arrojadas em realidade. Nossa trajetória traz a bagagem de grandes edifícios e residências de alto padrão, projetados e executados sob o mais rígido padrão de excelência para garantir a satisfação absoluta de nossos clientes.
              </p>
              <div className="mt-6">
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-12">
          ...
          <div className="max-w-3xl flex flex-col items-start">
            ...
            <p className="mt-4 text-gray-600 text-xs sm:text-sm tracking-wide leading-relaxed">
              Combinamos rigor analítico de engenharia com a sensibilidade estética e inovadora da arquitetura de alto padrão. Conheça os especialistas dedicados a transformar o seu projeto em um legado atemporal.
            </p>
          </div>
      ...
      <section id="servicos" className="relative w-full bg-[#121417] py-12 md:py-20 px-4 sm:px-6 border-t border-white/5 z-10 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col gap-8 md:gap-10">
              ...
              >
                ...
                <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 md:hover:-translate-y-1 group cursor-pointer w-[calc((100%-1rem)/2)] md:w-[calc((100%-3rem)/3)] shrink-0">
                  <div className="text-[#c5a880] group-hover:text-white transition-colors duration-300 mt-1 transform group-hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 md:w-11 md:h-11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="m15 5-3-3-3 3"/><path d="M12 2v20"/><path d="m5 16 7-9 7 9"/><path d="M19 19H5"/></svg>
                  </div>
                  <div className="flex flex-col items-center flex-grow justify-center mt-4">
                    ...
                    <p className="text-xs md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-3">Projetos conceituais que equilibram perfeitamente criatividade e funcionalidade.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 md:hover:-translate-y-1 group cursor-pointer w-[calc((100%-1rem)/2)] md:w-[calc((100%-3rem)/3)] shrink-0">
                  <div className="text-[#c5a880] group-hover:text-white transition-colors duration-300 mt-1 transform group-hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 md:w-11 md:h-11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                  </div>
                  <div className="flex flex-col items-center flex-grow justify-center mt-4">
                    <h3 className="font-serif text-lg md:text-2xl tracking-wide font-light text-white mb-2">Residencial</h3>
                    <p className="text-xs md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-3">Casas exclusivas de alto padrão construídas com precisão e cuidado absoluto.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 md:hover:-translate-y-1 group cursor-pointer w-[calc((100%-1rem)/2)] md:w-[calc((100%-3rem)/3)] shrink-0">
                  ...
                  <div className="flex flex-col items-center flex-grow justify-center mt-4">
                    ...
                    <p className="text-xs md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-3">Interiores sofisticados, marcenaria e detalhamento adaptados ao seu bem-estar.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 md:hover:-translate-y-1 group cursor-pointer w-[calc((100%-1rem)/2)] md:w-[calc((100%-3rem)/3)] shrink-0">
                  ...
                  <div className="flex flex-col items-center flex-grow justify-center mt-4">
                    ...
                    <p className="text-xs md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-3">Execução contínua e transparente, cuidando dos custos até a entrega das chaves.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#1a1d24]/40 border border-white/20 rounded-xl p-6 md:p-8 flex flex-col items-center text-center justify-between transition-all duration-300 hover:border-[#9a1c24] hover:bg-[#1a1d24]/80 md:hover:-translate-y-1 group cursor-pointer w-[calc((100%-1rem)/2)] md:w-[calc((100%-3rem)/3)] shrink-0">
                  ...
                  <div className="flex flex-col items-center flex-grow justify-center mt-4">
                    ...
                    <p className="text-xs md:text-base text-gray-400 tracking-wide leading-relaxed line-clamp-3">Estudos de viabilidade técnica, laudos estruturais e análises patrimoniais.</p>
                  </div>
                </div>
          ...
          <div className="flex justify-center items-center gap-2 mt-2">
            ...
            {isMobile && (
              <button onClick={() => setGrupoAtivo(2)} className={`h-1.5 rounded-full transition-all duration-300 ${grupoAtivo === 2 ? 'w-6 bg-[#9a1c24]' : 'w-2 bg-white/20'}`} />
            )}
          </div>
